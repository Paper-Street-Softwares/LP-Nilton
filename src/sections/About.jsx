      ...
      <div className="bg-neutral-100 ">
        <SectionArea>
          <div className="flex flex-col items-center max-w-7xl">
            ...
            <MotionDivDownToUp>
              <div className="flex flex-col max-w-6xl gap-8 p-8 bg-white border border-gray-100 shadow-2xl md:gap-16 rounded-2xl sm:p-12 lg:flex-row">
                <MotionDivDownToUp className="">
                  <div className="flex justify-center md:items-center">
                    <img
                      src={content.about.imagem.imgPessoa}
                      alt="Imagem ilustrativa"
                      className="w-[90%] phone3:w-[295px] tablet1:w-[400px] max-w-[480px] rounded-lg h-auto"
                    />
                  </div>
                </MotionDivDownToUp>
